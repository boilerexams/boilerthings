...
function App() {
	useEffect(() => {
		...
		if (favicon) {
			favicon.href =
				"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'><rect width='64' height='64' fill='black'/></svg>";
		}
	}, []);
			...
			<Navbar className="bp3-dark custom-navbar">
				<Navbar.Group align={Alignment.LEFT} className="navbar-header">
					...
					<p className="description">
						Websites for Boilermakers, by Boilermakers
					</p>
				</Navbar.Group>
			</Navbar>
			...
			<div className="content">
				<Card className="custom-card" interactive={true}>
					...
					<Button
						...
						icon="arrow-right"
						text="Boilerexams.com"
						onClick={() => window.open("https://boilerexams.com", "_blank")}
					/>
					<Button
						className="custom-button"
						icon="arrow-right"
						text="CHENFLIX"
						onClick={() => window.open("https://chenflix.vercel.app", "_blank")}
					/>
				</Card>
				...
				<Card className="custom-card" interactive={true}>
					...
					<Button
						className="custom-button"
						icon="arrow-right"
						text="BoilerBookings.com"
						onClick={() => window.open("https://boilerbookings.com", "_blank")}
					/>
					<Button
						className="custom-button"
						icon="arrow-right"
						text="PurduePool.com"
						onClick={() => window.open("https://purduepool.com", "_blank")}
					/>
				</Card>
				...
				<Card className="custom-card" interactive={true}>
					...
					<Button
						className="custom-button"
						icon="arrow-right"
						text="BoilerClasses.com"
						onClick={() => window.open("https://boilerclasses.com", "_blank")}
					/>
					<Button
						className="custom-button"
						icon="arrow-right"
						text="BoilerGrades.com"
						onClick={() => window.open("https://boilergrades.com", "_blank")}
					/>
				</Card>
